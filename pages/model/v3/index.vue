...
const submitForm = async () => {
  ...
  await useFetch("/proxy/model/v3", {
    ...
    body: {
      ...
      EnvironmentSatisfaction: formData.value.EnvironmentSatisfaction,
      JobInvolvement: formData.value.JobInvolvement,
      JobSatisfaction: formData.value.JobSatisfaction,
      PerformanceRating: formData.value.PerformanceRating,
      RelationshipSatisfaction: formData.value.RelationshipSatisfaction,
      WorkLifeBalance: formData.value.WorkLifeBalance,
      YearsSinceLastPromotion: formData.value.YearsSinceLastPromotion,
...
const generateRandomValues = () => {
  ...
  // Additional Fields
  formData.value.EnvironmentSatisfaction = Math.floor(Math.random() * 4) + 1; // Example for EnvironmentSatisfaction (1-4)
  formData.value.JobInvolvement = Math.floor(Math.random() * 4) + 1; // Example for JobInvolvement (1-4)
  formData.value.JobSatisfaction = Math.floor(Math.random() * 4) + 1; // Example for JobSatisfaction (1-4)
  formData.value.PerformanceRating = Math.floor(Math.random() * 4) + 1; // Example for PerformanceRating (1-4)
  formData.value.RelationshipSatisfaction = Math.floor(Math.random() * 4) + 1; // Example for RelationshipSatisfaction (1-4)
  formData.value.WorkLifeBalance = Math.floor(Math.random() * 4) + 1; // Example for WorkLifeBalance (1-4)
  formData.value.YearsSinceLastPromotion = Math.floor(Math.random() * 20); // Example for YearsSinceLastPromotion
  // Random values for GrossSalary, DailyRate, and MonthlyIncome
  formData.value.GrossSalary = Math.floor(Math.random() * 4001) + 1000; // Example range for GrossSalary (1000-5000)
  formData.value.DailyRate = Math.floor(Math.random() * 200) + 50; // Example range for DailyRate (50-249)
  formData.value.MonthlyIncome = Math.floor(formData.value.GrossSalary * 0.75);
};
</script>
...
<template>
  <div class="rounded-lg border bg-card p-6">
    <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">
      Predection Form - Model Version 3.0
    </h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div class="mb-1">
            <label
              ...
              class="block mb-1 text-xs font-medium text-gray-900 dark:text-white"
              >EnvironmentSatisfaction</label
            >
            <select
              v-model="formData.EnvironmentSatisfaction"
          ...
          <div class="mb-1">
            <label
              for="JobInvolvement"
              class="block mb-1 text-xs font-medium text-gray-900 dark:text-white"
              >JobInvolvement</label
            >
            <select
              v-model="formData.JobInvolvement"
              id="JobInvolvement"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              required
            >
          ...
          <div class="mb-1">
            <label
              for="JobSatisfaction"
              class="block mb-1 text-xs font-medium text-gray-900 dark:text-white"
              >JobSatisfaction</label
            >
            <select
              v-model="formData.JobSatisfaction"
              id="JobSatisfaction"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              required
            >
          ...
          <div class="mb-1">
            <label
              ...
              class="block mb-1 text-xs font-medium text-gray-900 dark:text-white"
              >RelationshipSatisfaction</label
            >
            <select
          ...
          <div class="mb-1">
            ...
            >
            <select
              v-model="formData.WorkLifeBalance"
              id="WorkLifeBalance"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              required
            >
          ...
          <div class="mb-1">
            <label
              ...
              class="block mb-1 text-xs font-medium text-gray-900 dark:text-white"
              >YearsSinceLastPromotion</label
            >
            <input
              v-model="formData.YearsSinceLastPromotion"
              type="number"
